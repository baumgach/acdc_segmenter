...
class DataMakerACDC:
    ...
    def __init__(self, out_file_name, base_path, n_x, n_y, target_resolution):
        ...
        for folder in os.listdir(self.base_path):
            ...
            if os.path.isdir(folder_path):
                ...
                for file in glob.glob(os.path.join(folder_path, 'patient???_frame??.nii.gz')):
                    ...
                    scaling_factor = (pixel_size[0]/self.target_resolution[0], pixel_size[1]/self.target_resolution[1])
...
if __name__ == '__main__':
    ...
    data_maker = DataMakerACDC('newdata_212x212.hdf5', base_path, n_x, n_y, target_resolution=(1.36719, 1.36719))
