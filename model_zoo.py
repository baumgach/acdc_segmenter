...
def unet2D_bn_padding_same(images, training):
    ...
    pred = layers.conv2D_layer_bn(conv9_2, 'pred', num_filters=NUM_CLASSES, kernel_size=(1,1), activation=layers.linear_activation, training=training)

    return pred



def unet2D_bn_modified(images, training):
    ...
    pred = layers.conv2D_layer_bn(conv9_2, 'pred', num_filters=NUM_CLASSES, kernel_size=(1,1), activation=layers.linear_activation, training=training, padding='VALID')

    return pred



def unet2D_bn(images, training):
...
def unet3D_bn(images, training):
    ...
    pred = layers.conv3D_layer_bn(conv8_2, 'pred', num_filters=NUM_CLASSES, kernel_size=(1,1,1), activation=layers.linear_activation, training=training, padding='VALID')

    return pred



def unet3D_bn_modified(images, training):
